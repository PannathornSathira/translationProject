...
function EngToThaiTransformer() {
  ...
  const handleTranslate = async () => {
    try {
      const response = await fetch('http://127.0.0.1:5000/translateEng2thaiTransformer', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="container">
      ...
      <div className="flags">
        ...
        <div className="flag">
          <Link to="/thai2engTransformer">⇄</Link>
        </div>
        <div className="flag">
      ...
      <p></p>
      <Link to="/"><button>Change model</button></Link>
...
export default EngToThaiTransformer;
