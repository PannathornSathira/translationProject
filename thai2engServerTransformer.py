...
model_name = "./Models/th2en_transformer.pth"  # Replace with your model path or name
tokenizer_path = "./Models/thai_to_eng_BART"
...
class Translator:
    ...
    def translate(self, input_text, max_seq_length):
        ...
        start_symbol = tokenizer.lang_code_to_id['en_XX']
...
@app.route('/translateThai2engTransformer', methods=['POST'])
def translate():
